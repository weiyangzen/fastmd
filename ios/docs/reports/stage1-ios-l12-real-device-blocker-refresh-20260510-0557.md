...
- Generated: 2026-05-10 05:57:15 +0800
- Generated UTC: 2026-05-09T21:57:15Z
...
iOS-owned implementation item. L1 iOS canonical fixture matrix, L2 core
...
The SwiftPM validation gate passes. The current physical-device probes do not
show any connected physical iPhone 12, iPhone 12 mini, iPhone 12 Pro, or iPhone
12 Pro Max. Because the required hardware is absent, the Stage 1 physical
open, render, search, edit, save, and rotate flow could not be executed.

## Changed iOS Files

- `ios/docs/reports/stage1-ios-l12-real-device-blocker-refresh-20260510-0557.md`
...
| `xcrun xctrace list devices` | `ios/` | PASS command, BLOCKED gate | Probe exited 0 and listed the Mac host, two offline physical iOS records, and simulator destinations. The `iPhone 12` entry appeared under simulators, not as connected physical hardware. |
