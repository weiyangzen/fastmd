# Stage 1 iOS L12 Real-Device Live Blocker - 2026-05-06 22:38 CST
...
| --- | --- | --- |
| `swift test` | PASS | Built `FastMDMobile`; executed 219 tests with 0 failures in 15.582 seconds. |
| `xcrun simctl list devices available \| rg 'iPhone 12'` | PASS | An available `iPhone 12` simulator destination was listed. |
