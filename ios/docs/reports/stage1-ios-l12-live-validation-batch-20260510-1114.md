...
- Generated local: 2026-05-10 11:14:22 CST
- Generated UTC: 2026-05-10T03:14:22Z
...
This batch refreshed the current SwiftPM test gate, iPhone 12 simulator
build/test gates, and physical-device inventory probes. It does not complete
the physical-device validation gate because no connected physical iPhone
12-family hardware was available.

## Validation Commands

| Command | Working directory | Result | Evidence |
| --- | --- | --- | --- |
| `swift test` | `ios/` | PASS | Build complete; 265 XCTest cases executed, 0 failures, 0 unexpected failures, 44.269s test time. |
...
| `xcodebuild -scheme FastMDMobile -destination 'platform=iOS Simulator,name=iPhone 12' test` | `ios/` | PASS | `** TEST SUCCEEDED **`; 265 XCTest cases executed, 1 skipped, 0 failures, 0 unexpected failures, 22.524s test time. |
...
- `ios/docs/reports/stage1-ios-l12-live-validation-batch-20260510-1114.md`
