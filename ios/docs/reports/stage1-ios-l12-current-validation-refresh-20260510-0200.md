...
- Generated: 2026-05-10 02:00 CST
...
validation evidence only: SwiftPM tests, generated SwiftPM/Xcode iPhone 12
simulator build/test prerequisites, and physical-device inventory probes.
...
- `ios/docs/reports/stage1-ios-l12-current-validation-refresh-20260510-0200.md`

## Validation

| Command | Working directory | Result | Evidence |
| --- | --- | --- | --- |
| `swift test` | `ios/` | PASS | Built the SwiftPM package and executed 235 XCTest cases with 0 failures and 0 unexpected failures. |
...
| `xcodebuild -list` | `ios/` | PASS for generated SwiftPM scheme inventory | Xcode resolved the SwiftPM package and exposed the generated `FastMDMobile` scheme. No checked-in `.xcodeproj` or `.xcworkspace` exists under `ios/`; Xcode used the SwiftPM-generated workspace. |
...
simulator identifiers, and DerivedData paths are intentionally omitted from this
report. Retained hardware signals are limited to model classes needed to
explain the L12 blocker.
