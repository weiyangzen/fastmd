# Stage 1 Android L12 Lint Validation Batch 166 - 2026-05-10
...
- `android/docs/reports/stage1-android-l12-lint-validation-batch166-20260510.md`
...
| `JAVA_HOME="/usr/local/opt/openjdk@17/libexec/openjdk.jdk/Contents/Home" PATH=".../bin:$PATH" java -version` | PASS | Reported Homebrew OpenJDK `17.0.17`. |
| `JAVA_HOME="/usr/local/opt/openjdk@17/libexec/openjdk.jdk/Contents/Home" PATH=".../bin:$PATH" ANDROID_HOME="$HOME/Library/Android/sdk" ANDROID_SDK_ROOT="$HOME/Library/Android/sdk" ./gradlew lint --no-daemon --console=plain` | PASS | Gradle reported `BUILD SUCCESSFUL in 20s`; `201 actionable tasks: 10 executed, 191 up-to-date`. |
